...
const steps: Step[] = [
  {
    ...
    command: "/ccp",
    title: "Setup",
    description: "First run auto-initializes project context and semantic search indexing.",
  },
  {
    number: 2,
    icon: FileText,
  ...
  },
  {
    ...
    command: "/ccp",
    title: "Implement",
    description: "Executes the approved plan with TDD enforcement and context management.",
  },
  {
    number: 4,
    icon: CheckCircle2,
